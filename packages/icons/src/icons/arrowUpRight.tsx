...
const ArrowUpRight = (props: SVGProps<any>, ref: Ref<any>) => (
  <svg
    width={24}
    height={24}
    viewBox="0 0 24 24"
  ...
  >
    <path
      ...
      fill="currentColor"
      className="arrow-up-right__Vector"
    />
  </svg>
)

const ForwardRef = forwardRef<SVGSVGElement, Props>(ArrowUpRight)
export { ForwardRef as ArrowUpRight }
